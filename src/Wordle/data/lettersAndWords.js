...
export const potentialWords = [
    ...
    "print", "prize", "proof", "proud", "prove", "queen", "quick", "quiet", "quite", "quote","abide", "abode", "abort", "abyss", "acorn", "adept", "admin", "adobe", "afoot", "agape",
    "agile", "agony", "aisle", "alibi", "alloy", "aloft", "aloof", "amend", "amiss", "ample",
    "ankle", "annex", "annoy", "antic", "aorta", "apart", "aphid", "apron", "arbor", "ardor",
    "arena", "argon", "arise", "arson", "ascot", "ashen", "aside", "askew", "atlas", "atoll",
    "attic", "aunty", "avail", "avert", "avian", "avoid", "await", "awake", "award", "awash",
    "azure", "badly", "bagel", "balky", "banjo", "barge", "baron", "basil", "baton", "bawdy",
    "bayou", "beady", "beard", "beast", "bebop", "beget", "begun", "belch", "belie", "belly",
    "beret", "beset", "betel", "bevel", "bicep", "biddy", "bigot", "bilge", "binge", "bingo",
    "biome", "birch", "bison", "black", "blame", "bland", "bleak", "bleat", "bleed", "blend",
    "blimp", "blink", "bliss", "blitz", "bloat", "bloke", "blond", "bloom", "blown", "bluer",
    "bluff", "blurt", "blush", "bogey", "bogus", "booby", "boost", "booth", "booty", "booze",
    "borax", "bosom", "botch", "bough", "boule", "bound", "bovid", "bowel", "boxer", "brace",
    "braid", "brand", "brash", "bravo", "brawl", "brawn", "breed", "briar", "bribe", "bride",
    "brine", "bring", "brink", "brisk", "broad", "broil", "broke", "brood", "brook", "broom",
    "broth", "brown", "brunt", "brush", "brute", "buddy", "buggy", "bugle", "bulge", "bulky",
    ...
    "carat", "cargo", "carol", "carry", "carte", "catch", "cater", "catty", "caulk", "cause",
    "cedar", "cello", "chafe", "chaff", "chain", "chair", "chalk", "champ", "chant", "chard",
    "charm", "chart", "chase", "chasm", "cheap", "cheat", "check", "cheek", "cheer", "chest",
    "chick", "chide", "chief", "child", "chili", "chill", "chime", "chirp", "chock", "choir",
    "choke", "chomp", "chord", "chore", "chuck", "chump", "chunk", "churn", "chute", "cider",
    ...
    "colon", "comet", "comfy", "comic", "comma", "conch", "condo", "conic", "copse", "coral",
    "corny", "couch", "cough", "could", "count", "coupe", "court", "coven", "cover", "covet",
    "covey", "cower", "coyly", "crack", "craft", "cramp", "crane", "crank", "crash", "crass",
    "crate", "crave", "crawl", "craze", "creak", "cream", "credo", "creed", "creek", "creep",
    ...
    "funky", "funny", "furry", "fussy", "fuzzy", "gaffe", "gaily", "gamer", "gamma", "gamut",
    "gassy", "gaudy", "gauge", "gaunt", "gauze", "gavel", "gawky", "gayer", "gayly", "gazer",
    "gecko", "geeky", "geese", "genie", "genre", "ghost", "ghoul", "giant", "giddy", "gipsy",
    "girly", "girth", "given", "giver", "glade", "gland", "glare", "glass", "glaze", "gleam",
    "glean", "glide", "glint", "gloat", "globe", "gloom", "glory", "gloss", "glove", "glowy",
    "glued", "glute", "glyph", "gnash", "gnome", "godly", "going", "golem", "golly", "goner",
    "goody", "gooey", "goofy", "goose", "gorge", "gouge", "gourd", "grace", "grade", "graft",
    "grail", "grain", "grand", "grant", "grape", "graph", "grasp", "grass", "grate", "grave",
    "gravy", "graze", "great", "greed", "green", "greet", "grief", "grill", "grime", "grind",
    ...
    "hovel", "hover", "howdy", "human", "humid", "humor", "humph", "hunky", "hurry", "husky",
    ...
    "jolly", "joust", "judge", "juice", "jumbo", "jumpy", "junta", "junto", "juror", "kappa",
    ...
    "prove", "prowl", "proxy", "prude", "prune", "pryer", "psalm", "pubic", "pudgy", "puffy",
    ...
    "trash", "trawl", "tread", "treat", "trend", "trial", "tribe", "trice", "trick", "tried",
